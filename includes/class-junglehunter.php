...
class Junglehunter {
     ...
     * @since    1.0.0
     * @access   protected
     * @var      Junglehunter_Loader $loader Maintains and registers all hooks for the plugin.
     */
    protected $loader;
     ...
     * Load the dependencies, define the locale, set the hooks for the admin area and
     * the public-facing side of the site and set the rest hooks.
     *
     * @since    1.0.0
     */
     ...
     * - Junglehunter_Public. Defines all hooks for the public side of the site.
     * - Junglehunter_Rest. Defines all hooks for the endpoints
     *
    ...
    private function load_dependencies() {
         ...
         * side of the site.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'public/class-junglehunter-public.php';
    ...
    private function define_public_hooks() {
        $plugin_public = new Junglehunter_Public($this->get_plugin_name(), $this->get_version());

        $this->loader->add_action('wp_enqueue_scripts', $plugin_public, 'junglehunter_enqueue_styles');
        $this->loader->add_action('wp_enqueue_scripts', $plugin_public, 'junglehunter_enqueue_scripts');
    }
     ...
     *
     * @return    Junglehunter_Loader    Orchestrates the hooks of the plugin.
     * @since     1.0.0
     */
